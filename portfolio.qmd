...
![](https://raw.githubusercontent.com/edwardarchaeology/SAR_Segmentation_with_SAM3_UNET/main/sam3unet.jpg){.project-thumb}

### SAM3SAR: Ship Segmentation in SAR (Research)

**Impact:** Improved ship detection by adapting SAM3-UNet to SAR imagery and building a full workflow from dataset prep to inference on never-seen Sentinel-1 scenes.

**What it does:** Segments ships in SAR imagery using a SAM3-UNet model, with training, evaluation, and tiled inference utilities.
...
[Deep learning]{.badge} [SAR]{.badge} [Remote sensing]{.badge}
