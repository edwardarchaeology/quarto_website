...
![](assets/project_images/sar_ship_id/sar_ship_id.png){.project-thumb}

### Maritime Ship Identification in SAR (Port Authorities & Insurers)

**Impact:** Reduced manual scanning of wide-area SAR scenes by automating ship identification, enabling faster monitoring of traffic density, potential anomalies, and risk exposure.

**What it does:** Segments vessels in SAR imagery using a SAM3-UNet model, with full training and tiled inference workflows for large Sentinel-1 scenes.

**Tech:** Python · PyTorch · SAM3 · UNet · Remote sensing

[View code](https://github.com/edwardarchaeology/SAR_Segmentation_with_SAM3_UNET){.btn .btn-primary .btn-sm}

[Deep learning]{.badge} [SAR]{.badge} [Maritime]{.badge}
